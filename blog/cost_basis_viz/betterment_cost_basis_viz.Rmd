...
- BNDX is the only bond fund to have a higher capital change than a stock. 🤔
- I apparently have some SCHB and VBR at a significant loss, down about 20%. I had not idea. 🤷
♂. I wonder why it hasn't been TLH'd yet. 
```{r}
return_summary1 <- 
  clean_data %>% 
  group_by(Symbol) %>%
